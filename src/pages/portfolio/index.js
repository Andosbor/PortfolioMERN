...
import psychicGame from '../../assets/images/banjo.jpg';
import "./styles.css";
...
<div id="main-container" className="container portfolio-container">
    <section className="main-section portfolio-section">
      ...
      <div className="work">
        <a href = "https://thawing-dusk-95690.herokuapp.com/"> <img class="cryptidX" src="assets\images\thomas-griesbeck-149034-unsplash.png" alt="CryptidX"/></a>

        <h3>CryptidX</h3>
      </div>
      <div className="work">
        <a href = "https://andosbor.github.io/TriviaGame/"><img src="assets/images/burgers3.jpg" alt="Trivia Game"/></a>

        <h3>Trivia Game</h3>
      </div>
      <div className="work">
        <a href = "https://andosbor.github.io/GifTastic/"> <img src="assets/images/banjo.jpg" alt="GifTastic"/> </a>

        <h3>Game Search</h3>
      </div>
      <div className="work">
        <a href = "https://andosbor.github.io/project_number_one/"><img src="assets/images/background4.jpeg" alt="skyQ"/></a>

        <h3>skyQ</h3>
      </div>
      <div className="work">
        <a href = "https://scavenger19.herokuapp.com/"> <img src="assets/images/scAvengersPic.png" alt="ScAvengers"/></a>
